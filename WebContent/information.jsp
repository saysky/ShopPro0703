					...
					<div class="user-info">
						...
						<div class="info-main">
							<form class="am-form am-form-horizontal" action="UserServlet?action=modifeRegistInfo" method="post">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2"  name="nick_name" placeholder="nickname">
							...
							<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-address" placeholder="Address" name="address" type="text">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-code" placeholder="Code" name="code" type="text">
